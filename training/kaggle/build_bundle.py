...
def main():
    ...
    nb = {
        ...
        "metadata": {
            ...
            # NOTE: do NOT add a "kaggle" key here — an experimental
            # kaggle.accelerator entry made Kaggle's importer fail silently
            # (every import after it produced an empty notebook).
